...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "VER-2-14-1"
  WORKING_DIRECTORY "/home/runner/work/ImBored/ImBored/_codeql_build_dir/_deps/freetype-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("VER-2-14-1" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: VER-2-14-1")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/VER-2-14-1")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"VER-2-14-1\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/ImBored/ImBored/_codeql_build_dir/_deps/freetype-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/ImBored/ImBored/_codeql_build_dir/_deps/freetype-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
